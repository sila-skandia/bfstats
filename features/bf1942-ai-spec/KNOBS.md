...
| avoid | the board target, the mount | the hull the bot walks to board is not planted; a soldier's circles go when he mounts | not read | `avoidBodies`, `ageObstacles` | INVENTION |
