...
| **Radio commands and the message log** (2026-09-23). The F1..F8 menu, its messages, voices and chat lines; the three-section kill / game-information / chat log | radio key handler 0x006D42A0, team and shouted receive 0x006D3400 / 0x006D2790, grid square 0x006ACDB0, `addChatMessageInternal` 0x006A89C0 and the log update 0x006A8160, `GameServer::radioMessage` (lnxded 0x0813A120) | [`../radio-and-chat-log/README.md`](../radio-and-chat-log/README.md). Open: `BfMenu+0x6DC` (conquest's radio game mode), why on-foot kills print `[killed]`, bots reacting to radio |
