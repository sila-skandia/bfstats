 ...
 *
 * The drawing half — the wash, the text layout, the bitmap font — is
 * `console-view.js`, re-exported from here.
 */

export {
  WASH, TEXT_COLOR, TEXT_X, TEXT_Y0, LINE_GAP, BAND_PAD,
  bandHeight, BitmapFont, paintConsole, loadConsoleFont,
