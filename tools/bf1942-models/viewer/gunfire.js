...
import { adopt, advanceImpacts, advancePuffs, sampleCurve, shellMaterial, spawnImpact,
         spawnPuff, tracerGeometry, tracerMaterial } from './round-visuals.js';
import { detonate, impact } from './round-impact.js';

export { sampleCurve, tracerMaterial };
...
export class GunFire {
   ...
   */
    ...
    if (!(blast && detonate(this, shot.group, spec, shot.mesh.position,
                                  shot.travelled))) {
  ...
  advance(dt) {
    ...
    for (let i = this.tracers.length - 1; i >= 0; i--) {
      ...
      if (struck) {
        ...
        impact(this, tracer.group, tracer.group.stats.projectile, struck,
    ...
    for (let i = this.projectiles.length - 1; i >= 0; i--) {
      ...
      if (shot.body) {
        ...
        if (struck && !this.#throughWater(shot, struck)) {
          ...
          impact(this, shot.group, shot.group.stats.projectile, struck,
