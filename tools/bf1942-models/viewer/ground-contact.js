// Where a driven land vehicle meets the ground: the drivable-deck policy, the
// Coulomb friction budget and its clamp (PHY-2), the spring law (PHY-5), the
// parking hold, a hull contact's friction, and the `Wheel` with the probes that
// find the surface under it. Shared by `GroundVehicle` (`ground.js`) and
