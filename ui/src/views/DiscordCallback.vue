  ...
  <div class="portal-page flex items-center justify-center min-h-screen">
    ...
    <div class="portal-inner flex items-center justify-center">
      <div class="text-center">
        <div
          v-if="error"
          class="bg-red-500/10 border border-red-500/50 rounded-xl p-6 max-w-md"
        >
        ...
        <div
          v-else
          class="bg-neutral-800/60 backdrop-blur-sm border border-neutral-700/50 rounded-xl p-6"
        >
