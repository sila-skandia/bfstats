      ...
      <div v-else-if="tournament">
        ...
        <div class="w-full max-w-screen-2xl mx-auto px-4 sm:px-8 lg:px-12 mt-8 sm:mt-12 space-y-8">
          ...
          <div v-if="isAuthenticated && registrationStatus">
                    ...
                    <div>
                      ...
                      >
                        Playing for <span
                          class="font-semibold"
                          :style="{ color: getAccentColor() }"
                        >{{ registrationStatus.teamMembership.teamName }}</span>
                        <span
                          v-if="registrationStatus.teamMembership.isLeader"
                          class="opacity-75"
                        > · Leader</span>
                        <span
            ...
            <div
              v-else-if="registrationStatus.isRegistrationOpen"
              class="text-center"
            >
              <div
          ...
          <div
            v-else-if="isAuthenticated && registrationStatusError && isTournamentInRegistration()"
            class="text-center"
          >
            <div
              class="inline-block backdrop-blur-sm border-2 rounded-xl p-6 sm:p-8"
          ...
          <div
            v-else-if="!isAuthenticated && isTournamentInRegistration()"
            class="text-center"
          >
            <div
              class="inline-block backdrop-blur-sm border-2 rounded-xl p-6 sm:p-8"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div class="px-6 py-4">
                  <!-- Players List -->
                  <div
                    v-if="team.players && sortedPlayers(team.players, isLeaderOfTeam(team.id)).length > 0"
                    class="space-y-2"
                  >
                    <p
                    ...
                    >
                      ...
                      <span
                        v-if="isLeaderOfTeam(team.id) && sortedPlayers(team.players, true).length > sortedPlayers(team.players).length"
                        class="text-amber-400 font-normal normal-case"
                      >
...
import { teamRegistrationService, TeamRecruitmentStatus, MembershipStatus, getRecruitmentStatusText, type RegistrationStatusResponse } from '@/services/teamRegistrationService'
...
const sortedTeams = computed(() => {
  ...
  const teams = tournament.value.teams.map(team => ({ ...team, players: [...team.players] }))
