...
const sortedAndFilteredCommunities = computed(() => {
  const result = [...communities.value]
    ...
    <div class="portal-inner">
      <div class="data-explorer">
        <div class="explorer-inner">
          ...
          <div
            v-if="loading && allCommunitiesCache.length === 0"
            class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"
          >
            <div
              v-for="i in 6"
              :key="i"
              class="animate-pulse bg-neutral-800 h-96 rounded"
            />
          </div>

          <!-- Error State (only for loading errors, not search errors) -->
          <div
            v-else-if="error && !searchQuery.trim()"
            class="explorer-card"
          >
          ...
          <!-- Empty State -->
          <div
            v-else-if="sortedAndFilteredCommunities.length === 0"
            class="explorer-card"
          >
          ...
          <!-- Results Summary -->
          <div
            v-if="!loading && sortedAndFilteredCommunities.length > 0"
