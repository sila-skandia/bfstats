<template>
  <div
    v-if="leaderboard && leaderboard.rankings.length > 0"
    class="backdrop-blur-sm border-2 rounded-xl overflow-hidden"
      ...
      <table class="w-full border-collapse">
        <thead>
          <tr :style="{ backgroundColor: backgroundMuteColor }">
            <th
              class="p-4 text-left font-bold text-xs uppercase border-b"
            ...
            <th
              class="p-4 text-center font-bold text-xs uppercase border-b"
              :style="{ color: textColor, borderColor: accentColor }"
            >
              Matches Played
            </th>
        ...
        <tbody>
          ...
          >
            ...
            <td class="p-4 text-center">
              <span
                class="text-sm font-mono"
                :style="{ color: ranking.ticketDifferential > 0 ? '#22c55e' : ranking.ticketDifferential === 0 ? '#eab308' : '#ef4444' }"
              >
  ...
  <div
    v-else
    class="backdrop-blur-sm border-2 rounded-xl p-8 text-center"
    :style="{ borderColor: accentColor, backgroundColor: backgroundSoftColor }"
  >
    <div
      v-if="logoImageUrl"
    ...
    >
      <img
        :src="logoImageUrl"
        alt="Community logo"
        class="max-h-32 object-contain opacity-70"
      >
    </div>
    <div
      v-else
