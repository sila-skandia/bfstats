      ...
      >
        ...
        <div class="border-t border-slate-700/30 pt-6">
          ...
          >
            ...
            <span
              v-if="formData.weekDates.length > 0"
              class="text-xs bg-cyan-500/30 text-cyan-300 px-2 py-1 rounded"
            >
          ...
          <!-- Panel Content -->
          <div
            v-if="expandedPanels.scheduleAndRules"
            class="space-y-4"
          >
            ...
            <div
              v-if="showWeekForm"
              class="mb-4 p-4 bg-slate-800/60 border border-slate-700/50 rounded-lg space-y-3"
            >
              <div>
        ...
        <div class="border-t border-slate-700/30 pt-6">
          ...
          >
            ...
            <span
              ...
              class="text-xs bg-blue-500/30 text-blue-300 px-2 py-1 rounded"
            >
          ...
          <!-- Panel Content -->
          <div
            v-if="expandedPanels.filesAndLinks"
            class="space-y-4"
          >
            <p class="text-xs text-slate-500">
              ...
              >
                ...
                >
                  ...
                  <div class="p-6 space-y-4">
                    ...
                    >
                      <div
                        :style="{ color: formData.theme?.accentColour || '#FFD700' }"
                        class="text-lg font-bold mb-2"
                      >
                        Sample Tournament
                      </div>
                      <div
                        :style="{ color: formData.theme?.textColour || '#FFFFFF' }"
                        class="text-xs"
                      >
                    ...
                    <div
                      ...
                      :style="{ borderColor: formData.theme?.accentColour || '#FFD700' }"
                    >
                      <div
                        class="px-3 py-2"
        ...
        >
          ...
          <div
            v-else-if="error && typeof error === 'object' && 'validationErrors' in error"
            class="space-y-3"
          >
