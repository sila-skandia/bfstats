<template>
  ...
  >
    <div class="bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-lg rounded-2xl border border-slate-700/50 w-full max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl flex flex-col">
          ...
          >
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <svg
                  class="w-5 h-5 text-slate-500 group-hover:text-cyan-400 transition-colors flex-shrink-0 ml-2"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        >
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 overflow-hidden">
            ...
            <div class="lg:col-span-2 flex flex-col overflow-hidden">
              ...
              <div
                v-else
                class="flex flex-col gap-4 overflow-y-auto flex-1"
              >
                ...
                <div
                  v-if="totalPages > 1"
                  class="flex items-center justify-between p-3 bg-slate-800/30 border border-slate-700/30 rounded-lg flex-shrink-0"
                >
            ...
            <div class="lg:col-span-1 flex flex-col">
              <div
                v-if="selectedImage"
                class="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-lg overflow-hidden flex flex-col h-full"
              >
                <!-- Preview Image -->
                <div
                  class="flex-1 bg-slate-900 overflow-hidden flex items-center justify-center min-h-32 cursor-pointer relative group"
                ...
                <div class="p-4 border-t border-slate-700/30 space-y-3">
                  <div>
                    ...
                    <p class="text-sm font-mono text-slate-200 break-all mt-1">
                  ...
                  <div>
                    ...
                    <p class="text-xs font-mono text-cyan-400 break-all mt-1">
              ...
              <div
                v-else
                class="bg-gradient-to-br from-slate-800/30 to-slate-900/30 border border-dashed border-slate-700/50 rounded-lg p-6 flex items-center justify-center text-center h-full"
              >
                <div>
      ...
      <div
        v-if="step === 'images'"
        class="sticky bottom-0 bg-gradient-to-r from-slate-800/95 to-slate-900/95 backdrop-blur-sm border-t border-slate-700/50 p-6"
      >
