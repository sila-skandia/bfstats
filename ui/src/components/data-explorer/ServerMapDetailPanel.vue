    ...
    >
      ...
      <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-6 border-b border-white/5 pb-8">
        ...
        <div class="flex items-center gap-3">
          <div
            v-if="isRefreshing"
            class="flex items-center gap-2 px-3 py-1 bg-cyan-500/10 border border-cyan-500/30 rounded"
          >
          ...
          <select
            ...
            class="bg-black/40 border border-white/10 rounded px-3 py-1.5 text-[10px] font-mono font-black text-white uppercase focus:outline-none focus:border-cyan-500/50 cursor-pointer"
      ...
      <section class="space-y-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div
            ...
            :key="stat.label"
            class="bg-black/40 border border-white/5 p-5 rounded-xl"
          >
        ...
        <div
          v-if="detail.activityPatterns?.length > 0"
          class="bg-black/40 border border-white/5 p-6 rounded-xl"
        >
          <div class="text-[9px] font-mono text-slate-500 uppercase tracking-widest mb-4">
            TEMPORAL_DENSITY_PATTERN
          </div>
