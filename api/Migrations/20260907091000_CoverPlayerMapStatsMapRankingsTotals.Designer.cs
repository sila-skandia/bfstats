...
namespace api.Migrations
{
    ...
    [Migration("20260907091000_CoverPlayerMapStatsMapRankingsTotals")]
    partial class CoverPlayerMapStatsMapRankingsTotals
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Data.Entities.AppData", b =>
                {
                    ...
                    b.ToTable("app_data", (string)null);
                });
            ...
            modelBuilder.Entity("api.Data.Entities.PlayerAchievement", b =>
                {
                    ...
                    b.HasIndex("AchievementType", "PlayerName", "AchievementId")
                    ...
                    b.HasIndex("PlayerName", "ServerGuid", "AchievementName")
                        .HasDatabaseName("IX_PlayerAchievements_PlayerName_ServerGuid_AchievementName");

                    b.HasIndex("AchievementType", "ServerGuid", "PlayerName", "AchievedAt")
            ...
            modelBuilder.Entity("api.Data.Entities.PlayerMapStats", b =>
                {
                    ...
                    b.HasIndex("PlayerName", "ServerGuid", "Year", "Month");

                    b.HasIndex("PlayerName", "Year", "ServerGuid", "MapName")
                        .HasDatabaseName("IX_PlayerMapStats_PlayerName_Year_ServerGuid_MapName");

                    b.HasIndex("MapName", "ServerGuid", "PlayerName", "Year", "Month", "TotalScore", "TotalKills", "TotalDeaths", "TotalRounds", "TotalPlayTimeMinutes")
            ...
            modelBuilder.Entity("api.Data.Entities.PlayerServerStats", b =>
                {
                    ...
                    b.HasIndex("PlayerName", "ServerGuid", "TotalRounds")
            ...
            modelBuilder.Entity("api.Data.Entities.PlayerStatsMonthly", b =>
                {
                    ...
                    b.HasIndex("Year", "PlayerName", "TotalScore", "TotalKills", "TotalRounds", "TotalDeaths", "TotalPlayTimeMinutes")
            ...
            modelBuilder.Entity("api.Data.Entities.ServerWrappedCache", b =>
                {
                    b.Property<string>("ServerGuid")
                        .HasColumnType("TEXT");
                    ...
                    b.HasKey("ServerGuid", "Year");

                    b.ToTable("ServerWrappedCaches");
                });
            ...
            modelBuilder.Entity("api.PlayerTracking.PlayerComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("api.PlayerTracking.PlayerSession", b =>
                {
                    ...
                    b.Property<DateTime?>("SyncedToNeo4jAt")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("PlayerName", "LastSeenTime")
                    ...
                    b.HasIndex("IsActive", "SyncedToNeo4jAt", "LastSeenTime")
            ...
            modelBuilder.Entity("api.PlayerTracking.Round", b =>
                {
                    ...
                    b.HasIndex("IsActive", "SyncedToNeo4jAt", "StartTime")
            ...
            modelBuilder.Entity("api.PlayerTracking.ServerComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("api.PlayerTracking.ServerPlayerRanking", b =>
                {
                    ...
                    b.HasIndex("PlayerName", "ServerGuid", "TotalScore")
            ...
            modelBuilder.Entity("api.PlayerTracking.TournamentComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("TournamentId", "MatchId", "CreatedAt");
            ...
            modelBuilder.Entity("api.PlayerTracking.PlayerComment", b =>
                {
                    b.HasOne("api.PlayerTracking.User", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("api.PlayerTracking.TournamentComment", b =>
                {
                    ...
                    b.HasOne("api.PlayerTracking.TournamentComment", "ParentComment")
                        .WithMany()
